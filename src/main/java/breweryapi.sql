...
INSERT INTO
breweries (id, name, image_url, description, beer_selection, aminities, website_url, address )
  VALUES
...
( '1',
 ...
 (
    ...
    '{Green Chile Cream Ale, Peach Tea Blond, Yellow Gold Hefe, Singing Canary IPA, Juicy Canary Hazy IPA, Mosaic Smash IPA, Rocker Box Red Ale, Peanut Butter Stout, Peakes and Pines Colab Ukrainian Imperial Stout }',
 ...
 (
    ...
    '{7258 Blonde Alew, Unibrau Hefeweizen, Panther IPA, Ole ‘59er Amber Ale, Roller Coaster Red Ale, Monumental Stout}',
 ...
 (
    ...
    '{Mushu Blonde, Humble Beginnings IPA, Cloudy with a Chance of Mango Hazy IPA, SMokin’ G-Dubya, Crazy RTowan Boy Red Ale, Batchburger Pilsner, Shandy Dandy Face Palm, Citra Smash, Mattchata Cream Ale}',
    '{ciders, partial menu }',
